package numerics
class ShiftN<DATA : DoubleLike<DATA>>(var field: IField<DATA>) : IField<DATA> {
    ...
    override fun set(i: Int, j: Int, v: DATA) {
        if (j > 0) {
            ...
            throw(IndexOutOfBoundsException("Trying to set the value of a boundary via a finiteDifference.field.numerics.ShiftN field"))
        }
    }

package numerics
class ShiftE<DATA : DoubleLike<DATA>>(var field: IField<DATA>) : IField<DATA> {
    ...
    override fun set(i: Int, j: Int, v: DATA) {
        if (i > 0) {
            ...
            throw(IndexOutOfBoundsException("Trying to set the value of a boundary via a finiteDifference.field.numerics.ShiftE field"))
        }
    }

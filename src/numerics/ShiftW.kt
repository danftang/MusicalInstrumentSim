package numerics
class ShiftW<DATA : DoubleLike<DATA>>(var field: IField<DATA>) : IField<DATA> {
    ...
    override fun set(i: Int, j: Int, v: DATA) {
        if (i < field.iSize() - 1) {
            ...
            throw(IndexOutOfBoundsException("Trying to set the value of a boundary via a finiteDifference.field.numerics.ShiftW field"))
        }
    }
